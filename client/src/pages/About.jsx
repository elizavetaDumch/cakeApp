                    ...
                    <div class="row align-items-center">
                                       ...
                                       {/* <Button variant="warning" type="submit" className="mt-4 pt-2 text-right" width="20px">
                                        ...
                                        <div class="col-12" >
                                            <div class="mt-4 pt-2 text-right" >
                                                <a href="MAIN_SHOP_ROUTE" class=" instructButton btn btn-warning" > <b>Выбрать десерт</b></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2">
                            <div class="section-title ml-lg-5">
                                ...
                                <p class="text mb-0">На нашем сайте вы можете создать свой <b>уникальный</b> десерт, используя наш  <b style={{color: "brown"}}>конструктор</b> состава. Добавьте в корзину понравившийся дизайн, а затем выберите начинку и корж, и мы сделаем все возможное, чтобы создать именно то, что вы хотели. </p>
                            </div>
                        </div>
                    </div>
